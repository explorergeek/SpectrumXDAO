...
// Constants
const TWITTER_HANDLE = 'SpectrumX';
const TWITTER_LINK = `https://twitter.com/${TWITTER_HANDLE}`;
const OPENSEA_ID = 'squarenft-bee9gqzrfl';
...
const App = () => {
  ...
  const checkIfWalletIsConnected = async () => {
    ...
    if (accounts.length !== 0) {
      ...
      //So user does not have to reconnect wallet to our page after intital login
      setupEventListener()
    } else {
  ...
  */
  ...
  const setupEventListener = async () => {
    ...
    try {
      ...
      if (ethereum) {
        ...
        const connectedContract = new ethers.Contract(CONTRACT_ADDRESS, bohoNFT.abi, signer);
  ...
  const CONTRACT_ADDRESS = "0x391FD55E2E3A7a9e5C65622ac5413f933eE17CB3";
    ...
    try {
      ...
      if (ethereum) {
        ...
        let nftTxn = await connectedContract.makeABohoNFT();
    ...
    <div className="App">
      <div className="container">
        <div className="header-container">
          ...
          <br/>
          <br/>
          <button className="cta-button connect-wallet-button" onclick={openSeaWindow}>
